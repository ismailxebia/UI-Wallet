package odt.aliqornan.uangku.custom;
...
/**
 * Created by Ismail Xebia Inspired by MIUI on 9/8/2017.
 */

public class KatarikScrollView extends ScrollView {
    ...
    public KatarikScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                if (isScrollToTop() && !isScrollToBottom()) {
                    ...
                    // Di bagian bawah juga ada di bagian atas
                    float yDiff = y - mInitialMotionY;
                    if (Math.abs(yDiff) > mTouchSlop && !isBeingDragged) {
                        isBeingDragged = true;
                    }
                } else {
                    //Tidak di bagian bawah maupun di atas
                    return super.onInterceptTouchEvent(event);
                }
                break;
            }
